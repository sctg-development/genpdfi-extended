...
pub struct FontCache {
    fonts: Vec<FontData>,
    pdf_fonts: Vec<crate::render::IndirectFontRef>,
    ...
    embedded_font_cache: HashMap<*const Vec<u8>, crate::render::IndirectFontRef>,
}
...
impl FontCache {
    ...
    pub fn get_pdf_font(&self, font: Font) -> Option<&crate::render::IndirectFontRef> {
