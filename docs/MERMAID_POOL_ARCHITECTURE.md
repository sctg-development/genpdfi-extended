...
- `mermaid_pool/` — TypeScript project (Vite + vite-plugin-singlefile).
...
Notes:
- The bundling step produces `mermaid_pool/dist/index.html` containing a single-file HTML bundle which the Rust example embeds using a data URI.
